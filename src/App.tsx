...
const TitleHeader = styled.header`
  font-family: "Endless Summer Personal use";
  font-size: 3rem;
  padding-top: 0.7rem;
  color: ${colors.dark};
  display: flex;
...
const TitleHeader2 = styled.header`
  font-family: "Poppins";
  font-size: 2rem;
  padding-top: 0.7rem;
  color: ${colors.dark};
...
const App: React.FC = () => {
  ...
  //update the start and end times of the region
  useEffect(() => {
  ...
  const backGroundColor = {
    backgroundColor: '#fdc07a', // background color
  };
      ...
      >
        <InnerWrapper>
          <TitleHeader>
            {" "}
            <div>
              <img src="./cslogo.png" alt="Ceylon Symphony Logo" style={{ width: '250px', height: 'auto', margin: '0px', padding:'10px'}} />
            </div>
          
          </TitleHeader>
          <h1 style={{color: "#370d1b" , textAlign:'center', fontFamily:'Public Sans', fontSize:'50px'}}>Wave Slizer</h1>
          <WaveformWrapper
